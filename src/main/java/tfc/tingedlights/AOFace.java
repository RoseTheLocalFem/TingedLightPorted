...
public class AOFace {
	...
	public void calculate(Direction pDirection, BlockAndTintGetter pLevel, BlockState pState, BlockPos pPos, BitSet pShapeFlags) {
		...
		BetterAdjacencyInfo.AdjacencyInfo adjacencyInfo = BetterAdjacencyInfo.AdjacencyInfo.valueOf(pDirection.name());
	...
	public void calcAOPartial(Direction pDirection, BlockAndTintGetter pLevel, BlockState pState, BlockPos pPos, BitSet pShapeFlags, BlockPos blockpos, LightManager manager, BetterAdjacencyInfo.AdjacencyInfo adjacencyInfo, BetterAdjacencyInfo adjacency, Vec3[] vertices, Color fallback) {
